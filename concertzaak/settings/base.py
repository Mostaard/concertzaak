"""
Django settings for concertzaak project.
...
INSTALLED_APPS = [
    ...
    'concertzaak.apps.core.apps.CoreConfig',
    'concertzaak.apps.blog',
    'concertzaak.apps.faq',
...
WSGI_APPLICATION = 'concertzaak.wsgi.application'
